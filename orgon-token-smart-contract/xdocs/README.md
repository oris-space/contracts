...
Orgon Token smart contracts.  Copyright © 2018 by ABDK Consulting.

**Author:** Mikhail Vladimirov <mikhail.vladimirov@gmail.com>

## How to Deploy ##

In order to deploy Orgon Token Smart Contract you need the following software
...
In order to deploy Orgon Token Smart Contract do the following:
...
4. Run deployment script: `loadScript ("OrgonTokenDeploy.js");`
