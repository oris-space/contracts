...
tests.push ({
  ...
  steps: [
    ...
    { name: "Alice deploys SafeMathWrapper contract",
      body: function (test) {
        var safeMathWrapperCode = loadContractCode ("SafeMathWrapper");
        test.safeMathWrapperContract = loadContract ("SafeMathWrapper");
    ...
    { name: "Make sure contract was deployed",
      ...
      body: function (test) {
        ...
        test.safeMathWrapper = getDeployedContract (
          "SafeMathWrapper", test.safeMathWrapperContract, test.tx);
      }},
    ...
    { name: "Safely add 3 to 5",
      body: function (test) {
        ...
        assertBNEquals ('result [1]', 8, result [1]);
      }},
    ...
    { name: "Safely subtract 3 from 5",
      body: function (test) {
        ...
        assertBNEquals ('result [1]', 2, result [1]);
      }},
    ...
    { name: "Safely multiply 3 by 5",
      body: function (test) {
        ...
        assertBNEquals ('result [1]', 15, result [1]);
      }},
