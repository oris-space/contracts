...
/**
 * Tell whether given transactions were executed.
 *
 * @param array of transaction hashs
 * @return true if all given transactions were executed, false otherwise
 */
function transactionsExecuted () {
  try {
    for (var i = 0; i < arguments.length; i++) {
      if (!web3.eth.getTransactionReceipt (arguments [i])) {
        return false;
      }
    }
